...
#------------------------------------------------------->
# Custom Paramaters Entered By Meks
####

SITE_BRANDING = " Aladdin OpenStack Dashboard Entry"
USE_SSL = False

# Enable extra setting for Ubuntu JuJu charms
ENABLE_JUJU_PANEL = True


# Turns SSL on along with configuringing the openstack-dashboard.conf file
# See https://docs.openstack.org/mitaka/config-reference/dashboard/configure.html
